#!/usr/bin/env python3
"""
Scraper for The Diary of a CEO transcripts from podscripts.co
...
PODCAST_URL = f"{BASE_URL}/podcasts/the-diary-of-a-ceo-with-steven-bartlett/"
...
def get_episode_links(page: int = 1) -> tuple[List[str], bool]:
    ...
    for link in soup.find_all('a', href=True):
        href = link['href']
        if href.startswith('/podcasts/the-diary-of-a-ceo-with-steven-bartlett/') and href != '/podcasts/the-diary-of-a-ceo-with-steven-bartlett/':
            slug = href.split('/')[-1]
...
def main():
    parser = argparse.ArgumentParser(description='Scrape DOAC transcripts from podscripts.co')
